...
${productName} ખરીદવા બદલ આપનો ખૂબ ખૂબ આભાર. આપનું પેમેન્ટ સફળ રહ્યું છે અને આપની PDF ફાઇલ્સ ડાઉનલોડ કરવા માટે તૈયાર છે.
          ...
          <tr>
            <td style="padding:32px 28px 8px 28px;">
              ...
              <p style="margin:0 0 20px 0;font-size:15px;line-height:1.6;color:#4b5563;">
                ${productName} ખરીદવા બદલ આપનો આભાર. ચુકવણી સફળતાપૂર્વક પૂર્ણ થઈ ગઈ છે. નીચે આપેલા લિંક બટન પર ક્લિક કરીને આપની PDF ડાઉનલોડ કરી શકો છો.
              </p>
